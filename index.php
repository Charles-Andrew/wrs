    ...
    <body id="page-top">
            ...
            <div class="container justify-content-end">
                ...
                <div class="collapse navbar-collapse text-center" id="navbarResponsive">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">Payment</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Contact</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded border border-primary border-3" href="redi/initOrder?orderinit">Order Now</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">We deliver the highest quality, cleanest, and FDA approved water right in front of your doorsteps.</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">We offer Cash on Delivery and Gcash Payment. <br><br><br>Please prepare the total payment upon delivery. </p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">For Gcash Transactions: <br>Name: Charles Andrew Barsubia<br>Number: 09307694071 <br><br>Present the proof of Gcash Payment Transaction upon delivery.</p></div>
                </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="e.g. Juan Fucker">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Reciever's Contact Number:</label>
                        <input type="text" class="form-control" placeholder="e.g. 09XXXXXXXXXX">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Complete Address:</label>
                        <textarea class="form-control" rows="3" placeholder="e.g. Taas Santol Kidapawan City"></textarea>
                    </div>
                    <div class="mb-3">
                        <form class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 text-md-start text-center">
                                <button class="btn btn-primary mt-md-4 mt-0">Add to Cart</button>
                            </div>
                        </form>
                    </div>
                    <div class="mb-3">
        ...
        <?php 
            if (isset($_SESSION['activeorder']) && $_SESSION['activeorder']) {
